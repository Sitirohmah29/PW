...
<body>
            ...
            <div class="card w-100 w-lg-400px">
                <div class="card-body">
                    <form action="{{ url('sign-in') }}" method="post" id="form-sign-in" onsubmit="HandlerSignIn(event)">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-lg btn-warning btn-submit fw-bolder" type="submit" onclick="resetButtonText()">Sign In</button>
                        </div>
                    </form>
    ...
    const HandlerSignIn = (event) => {
        ...
        if (email == '222310054@student.ibik.ac.id' && password == '222310054') {
            alert("Email: " + email + "\nPassword: " + password);
